...
void loop(){
  ...
  // BME680
  unsigned long bme680_millis = millis();
  bool bme680_reading = true;
  do{
    Serial.println("Failed to perform BME680 reading.");
    delay(1000);
    if(millis() >= bme680_millis+5000){
      Serial.print("\nAbort BME680 reading.\n");
      bme680_reading = false;
      break;
    }
...
/*  
  ...
  */
  ...
  float altitude_ = bme680.readAltitude(SEALEVELPRESSURE_HPA);
